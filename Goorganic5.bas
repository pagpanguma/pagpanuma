...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("org5")


	pdfv.init
	Panel1.AddView(pdfv,0,0,-1,-1)
	File.Copy(File.DirAssets,"soilfertility.pdf",File.DirRootExternal,"soilfertility.pdf")
	pdfv.getpdf(File.DirRootExternal&"/soilfertility.pdf")
