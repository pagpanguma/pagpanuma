...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("lay5")


	pdfv.init
	Panel1.AddView(pdfv,0,0,-1,-1)
	File.Copy(File.DirAssets,"susagriinphil.pdf",File.DirRootExternal,"susagriinphil.pdf")
	pdfv.getpdf(File.DirRootExternal&"/susagriinphil.pdf")
