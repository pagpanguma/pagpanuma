...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("ind3")


	pdfv.init
	Panel1.AddView(pdfv,0,0,-1,-1)
	File.Copy(File.DirAssets,"LACTOBACILLI.pdf",File.DirRootExternal,"LACTOBACILLI.pdf")
	pdfv.getpdf(File.DirRootExternal&"/LACTOBACILLI.pdf")
