...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("org3")


	pdfv.init
	Panel1.AddView(pdfv,0,0,-1,-1)
	File.Copy(File.DirAssets,"plantpropagation.pdf",File.DirRootExternal,"plantpropagation.pdf")
	pdfv.getpdf(File.DirRootExternal&"/plantpropagation.pdf")
