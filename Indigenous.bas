...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("indigenous1")
...
Sub Button5_Click
	StartActivity(Indigenous2)
End Sub

Sub Button4_Click
	StartActivity(Indigenous3)
End Sub
	
Sub Button1_Click
	StartActivity(Indigenous4)
End Sub

Sub Button2_Click
	StartActivity(Indigenous5)
End Sub

Sub Button3_Click
	StartActivity(Indigenous6)
End Sub
