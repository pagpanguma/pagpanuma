...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("org1")


	pdfv.init
	Panel1.AddView(pdfv,0,0,-1,-1)
	File.Copy(File.DirAssets,"watersoilconser.pdf",File.DirRootExternal,"watersoilconser.pdf")
	pdfv.getpdf(File.DirRootExternal&"/watersoilconser.pdf")
