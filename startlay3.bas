...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("lay3")


	pdfv.init
	Panel1.AddView(pdfv,0,0,-1,-1)
	File.Copy(File.DirAssets,"theoryonsusagri.pdf",File.DirRootExternal,"theoryonsusagri.pdf")
	pdfv.getpdf(File.DirRootExternal&"/theoryonsusagri.pdf")
